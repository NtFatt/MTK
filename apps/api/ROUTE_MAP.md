...
| PATCH | /api/v1/admin/inventory/items/:ingredientId |
| POST | /api/v1/admin/inventory/items/:ingredientId/adjust |
...
| POST | /api/v1/admin/maintenance/dev/set-stock |
...
| PATCH | /api/v1/admin/menu/items/:itemId/active |
| GET | /api/v1/admin/menu/items/:itemId/recipe |
| PUT | /api/v1/admin/menu/items/:itemId/recipe |
...
| PATCH | /api/v1/admin/vouchers/:voucherId/active |
| GET | /api/v1/carts/:cartKey |
| PUT | /api/v1/carts/:cartKey/items |
| DELETE | /api/v1/carts/:cartKey/items/:itemId |
| DELETE | /api/v1/carts/:cartKey/voucher |
| PUT | /api/v1/carts/:cartKey/voucher |
...
| PATCH | /api/admin/inventory/items/:ingredientId |
| POST | /api/admin/inventory/items/:ingredientId/adjust |
...
| POST | /api/admin/maintenance/dev/set-stock |
| POST | /api/admin/maintenance/reset-dev-state |
...
| PATCH | /api/admin/menu/items/:itemId/active |
| GET | /api/admin/menu/items/:itemId/recipe |
| PUT | /api/admin/menu/items/:itemId/recipe |
...
| PATCH | /api/admin/vouchers/:voucherId/active |
...
| DELETE | /api/carts/:cartKey/voucher |
| PUT | /api/carts/:cartKey/voucher |
